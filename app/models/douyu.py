...
__all__ = ['DouyuChannel', 'DouyuRoom', 'DouyuHost',
...
class DouyuHost(LiveTVHost):
    """ 房间 """
    __tablename__ = 'douyu_host'
...
class DouyuHostData(LiveTVHostData):
    """ 扫描主持数据保存，作为曲线图基础数据 """
    __tablename__ = 'douyu_host_data'
