...
class LiveTVSite(db.Model):
    ...
    code = db.Column(db.String, unique=True, index=True, doc='代码')
    name = db.Column(db.String, doc='名称')
    url = db.Column(db.String, unique=True, index=True, doc='官网地址')
    image = db.Column(db.String, doc='图片')
    show_seq = db.Column(db.Integer, index=True, doc='排序')
    description = db.Column(db.String, doc='站点描述')
...
class LiveTVChannel(db.Model):
    ...
    office_id = db.Column(db.String, index=True, doc='官方ID')
    short = db.Column(db.String, index=True, doc='简称')
    name = db.Column(db.String, index=True, doc='名称')
...
class LiveTVRoom(db.Model):
    ...
    office_id = db.Column(db.String, index=True, doc='官方ID')
    name = db.Column(db.String, index=True, doc='名称')
    url = db.Column(db.String, index=True, doc='访问URL')
    image = db.Column(db.String, doc='图片')
